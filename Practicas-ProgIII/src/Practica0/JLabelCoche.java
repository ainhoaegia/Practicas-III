...
public class JLabelCoche extends JLabel{
	 ...
	 */
	public JLabelCoche( String nombreImagenObjeto, int anchura, int altura ) {
	 ...
	 */
	public JLabelCoche( String nombreImagenObjeto, int anchura, int altura, double rotacion, float opacidad ) {
	...
	public void setImagen( String nomImagenObjeto ) {
        ...
        try {
    		...
    		if (!f.exists()) {
    			imgURL = JLabelCoche.class.getResource( nomImagenObjeto ).toURI().toURL();
    		}
